  ...
  dataSources: [
    ...
    // },
    {
      ...
      configuration: {
        friendlyName: 'Orthanc DICOMWeb Server',
        name: 'Orthanc',
        qidoRoot: 'https://pacs.preventi.ai/dicom-web',
        wadoRoot: 'https://pacs.preventi.ai/dicom-web',
        stowRoot: 'https://pacs.preventi.ai/dicom-web',
        wadoUriRoot: 'https://pacs.preventi.ai/wado',
